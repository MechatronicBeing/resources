...
git clone --progress -v "https://github.com/MechatronicBeing/resources-playing-video-games.git"
...
git clone --progress -v "https://github.com/MechatronicBeing/resources-simulating.git"
